                ...
                <div className={classes.ProfilePageContent}>
                    ...
                    <div className={classes.btnHolder}>
                        <div className={classes.btn}>
                            <a
                                className={classes.a}
                                target="_blank"
                                href="https://www.spotify.com/de/?utm_source=play&utm_campaign=wwwredirect">
                    ...
                    <div className={classes.btnHolder}>
                        <div className={classes.btn}>
                            <a
                                className={classes.a}
                                target="_blank"
                                href="https://www.spotify.com/de/account/overview/?utm_source=play&utm_campaign=wwwredirect">
                                KONTO ANZEIGEN
                                </a>
                        </div>
                    </div>
                    <div className={classes.btnHolder}>
                        <div className={classes.btn}>
                            <a
                                className={classes.a}
                                href="https://accounts.spotify.com/de/logout"
                            >
                                ABMELDEN
                                </a>
                        </div>
